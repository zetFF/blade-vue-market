    ...
    <AppLayout>
        <section class="section_hero relative w-full overflow-hidden">
            ...
            <div
                ...
                class="relative h-[90vh] min-h-[600px] md:min-h-[800px] w-full"
            >
                <!-- Background Slider -->
                <div
                ...
                >
                    ...
                    <div class="relative h-full w-full">
                        ...
                        <div class="absolute inset-0">
                            ...
                            ></div>
                            <div
                                class="absolute inset-0 bg-[url('/pattern-dot.png')] opacity-20"
                            ></div>
                            <div
                        ...
                        <div class="relative h-full w-full">
                            <div class="container mx-auto px-4 sm:px-6 h-full">
                                <div
                                    class="grid grid-cols-1 lg:grid-cols-12 h-full items-center gap-8"
                                >
                                    <!-- Left Content -->
                                    <div
                                        class="col-span-1 lg:col-span-6 space-y-6 md:space-y-8 py-8 md:py-0"
                                    >
                                        <!-- Badge & Title Section -->
                                        <div
                                        ...
                                        >
                                            ...
                                            >
                                                <span
                                                    class="px-3 py-1.5 md:px-4 md:py-2 bg-primary-500 text-white rounded-full text-xs md:text-sm font-medium shadow-lg shadow-primary-500/30 inline-flex items-center"
                                                >
                                                    <svg
                                                        class="w-3 h-3 md:w-4 md:h-4 mr-1.5 md:mr-2"
                                                        fill="currentColor"
                                                        viewBox="0 0 20 20"
                                                    >
                                                        <path
                                            ...
                                            <h1
                                                class="text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight tracking-tight"
                                            >
                                                {{ slider.title }}
                                            </h1>

                                            <p
                                                class="text-base md:text-xl text-gray-300 leading-relaxed font-light max-w-2xl"
                                            >
                                                {{ slider.description }}
                                            </p>
                                        </div>
                                        ...
                                        >
                                            <a
                                                v-if="slider.link"
                                                :href="slider.link"
                                                class="group relative inline-flex items-center px-6 py-3 md:px-8 md:py-4 bg-primary-500 text-white rounded-full overflow-hidden transition-all duration-300 text-sm md:text-base"
                                            >
                                                <span
                                                ...
                                                >
                                                <svg
                                                    class="w-5 h-5 md:w-6 md:h-6 ml-2 relative z-10 group-hover:translate-x-1 transition-transform duration-300"
                                                    fill="none"
                                                    viewBox="0 0 24 24"
                                                    stroke="currentColor"
                                                >
                                            ...
                                            <a
                                                href="#"
                                                class="group inline-flex items-center px-6 py-3 md:px-8 md:py-4 border-2 border-white/30 text-white rounded-full transition-all duration-300 hover:bg-white hover:text-gray-900 text-sm md:text-base"
                                            >
                                    ...
                                    <div
                                        class="hidden lg:block lg:col-span-5 lg:col-start-8"
                                    >
                                        <div
                                        ...
                                        >
                                            <div
                                                class="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 transform hover:scale-105 transition-all duration-300"
                                            >
                                                <div class="flex items-center">
                                                    <div class="flex-shrink-0">
                                                        <div
                                                            class="p-4 bg-primary-500/20 rounded-xl"
                                                        >
                                                            <svg
                                    ...
                                    <div
                                        class="lg:hidden col-span-1 grid grid-cols-1 sm:grid-cols-2 gap-4"
                                    >
                                        <div
                                            class="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/10"
                                        >
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0">
                                                    <div
                                                        class="p-3 bg-primary-500/20 rounded-lg"
                                                    >
                                                        <svg
                            ...
                            <div
                                class="absolute bottom-8 md:bottom-12 left-0 right-0 z-20"
                            >
                                <div class="container mx-auto px-4 sm:px-6">
                                    ...
                                    >
                                        <!-- Slide Counter -->
                                        <div
                                            class="hidden md:block text-white font-medium"
                                        >
                                            <span class="text-2xl">{{
                                                currentSlide + 1
                                            }}</span>
                                        ...
                                        <!-- Slide Controls -->
                                        <div
                                            class="flex items-center space-x-4 mx-auto md:mx-0"
                                        >
                                            <button
                                                @click="prevSlide"
                                                class="p-2 rounded-full border border-white/20 hover:bg-white/10 transition-colors duration-300"
                                            >
                                                <svg
...
<style>
/* Copy semua style dari Home.vue */
